...
import { Plus, Settings, Camera, X, Play, Image as ImageIcon, Send, Loader2 } from 'lucide-react'
...
export default function StatusTab({ onStatusClick }: StatusTabProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-[#111b21]">
      {/* Header Actions */}
      <div className="flex items-center justify-between px-4 py-3 bg-[#202c33] text-[#e9edef]">
